...
public class CameraFragment extends Fragment implements View.OnClickListener {
        ...
        private void process(CaptureResult result) {
            ...
            switch (mState) {
                ...
                case STATE_WAITING_LOCK: {
                    int afState = Objects.requireNonNull(result.get(CaptureResult.CONTROL_AF_STATE));
    ...
    private void startVoiceTimer() {
        ...
        Log.d(TAG, "startVoiceTimer: " + countdown);
        ...
        final TextView label = layout.findViewById(R.id.countdown_text);
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (mCountdown < 0) {
                            ...
                            label.setText(String.format( Locale.US, "Photo in %d", mCountdown));
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            ...
            for (String cameraId : manager.getCameraIdList()) {
                ...
                } else if (!shouldUseCamera(integer)) {
                ...
                Size largest = Collections.max(
                        Arrays.asList(Objects.requireNonNull(map).getOutputSizes(ImageFormat.JPEG)),
    ...
    private int getJpegOrientation(CameraCharacteristics c, int deviceOrientation) {
        ...
        if (deviceOrientation == android.view.OrientationEventListener.ORIENTATION_UNKNOWN)
            return 0;
        int sensorOrientation = Objects.requireNonNull(c.get(CameraCharacteristics.SENSOR_ORIENTATION));

        // Round device orientation to a multiple of 90
        deviceOrientation = (deviceOrientation + 45) / 90 * 90;

        // Reverse device orientation for front-facing cameras
        boolean facingFront = Objects.requireNonNull(c.get(CameraCharacteristics.LENS_FACING)) ==
